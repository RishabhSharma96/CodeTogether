                ...
                <div className="card">
                    <div className="card2">
                        <form className="form">
                            ...
                            <div className="btn">
                                <button className="button2" onClick={handleRedirecting}>Start Coding</button>
                                <button className="button3" onClick={handleCreateRoom}>Generate new Room ID</button>
                            </div>
                        </form>
                    </div>
                </div>
